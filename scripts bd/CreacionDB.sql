...
CREATE DATABASE [20171C_TP] ON  PRIMARY 
( NAME = N'20171C_TP', FILENAME = N'C:\SQLDATA\20171C_TP.mdf' , SIZE = 5MB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'20171C_TP_log', FILENAME = N'C:\SQLDATA\20171C_TP_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
